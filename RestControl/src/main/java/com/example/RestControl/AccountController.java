...
public class AccountController {
    ...
    public List<accounts> getAccounts () {
        ...
        accounts a2 = new accounts("<uid" + counter.getAndIncrement() + ">", "CSR #1", "101 West", "Main ST", 60010, "(847) 842-8048", "http://example.com/images/jane-smith.jpeg", true, formatted_date);
