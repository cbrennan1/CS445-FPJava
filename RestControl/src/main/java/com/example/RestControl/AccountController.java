...
public class AccountController {
    ...
    public List<accounts> getAccounts () {
        ...
        accounts a0 = new accounts("<uid" + counter.incrementAndGet() - 1 + ">", "Virgil Bistriceanu", "10 West", "31st ST", 60616, "312-567-5146", "http://cs.iit.edu/~virgil/pictures/virgil-head-small-200811.jpg", true, formatted_date);
